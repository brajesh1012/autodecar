  <?php include('head.php'); ?>
            ...
            <div class=" wrap-map flat-featured  listing-grid style flex listing-wrap-map">
                <div class="content-left wg-dream sidebar-left-listing listing-list-car-wrap">
                    <div class="category-filter flex justify-space align-center mb-30 flex-wrap gap-20 ">
                        <div class="box-1 ">
                            <h2 class="heading-listing">Used cars for sale</h2>                                             
                        </div>
                        <div class="box-2 flex flex-wrap gap-8">
                            ...
                            <div class="wd-find-select flex flex-wrap gap-20">
                                <div class="group-select">
                                    <div class="nice-select" tabindex="0"><span class="current">Sort by (Defaut)</span>
                                        <ul class="list style">                                                          
                                          <li data-value="" class="option selected">Sort by (Defaut)</li>
                    ...
                    <div class="list-car-1 list-car-list-1 list-car-grid-1">
                        <div class="box-car-list hv-one">
                                ...
                                <div class="swiper-container carousel-2 img-style">
                                    <div class="swiper-wrapper ">
                                        <div class="swiper-slide"><img class="lazyload"
                                                ...
                                                src="assets/images/car-list/car1.jpg" alt="image"></div>
                                        <div class="swiper-slide"><img class="lazyload"
                                                data-src="assets/images/car-list/car2.jpg"
                                                src="assets/images/car-list/car2.jpg" alt="image"></div>
                                        <div class="swiper-slide"><img class="lazyload"
                                                data-src="assets/images/car-list/car3.jpg"
                                                src="assets/images/car-list/car3.jpg" alt="image"></div>
                                        <div class="swiper-slide"><img class="lazyload"
                                                data-src="assets/images/car-list/car4.jpg"
                                                src="assets/images/car-list/car4.jpg" alt="image"></div>
                                    </div>
                                    <div class="pagi2">
                            ...
                            <div class="content">
                                ...
                                <h5 class="link-style-1">
                                    <a href="listing-detail-v5.html">2017 BMV X1 xDrive 20d xline</a>
                                </h5>
                                ...
                                <div class="days-box flex justify-space align-center">
                                    ...
                                    <a href="listing-detail-v5.html" class="view-car">View car</a>
                                </div>
                            </div>
                        </div>
                        <div class="box-car-list hv-one">
                            ...
                            <div class="content">
                                ...
                                <div class="days-box flex justify-space align-center">
                                    <div class="img-author">
                                        <img class="lazyload" data-src="assets/images/author/avt-cm2.jpg"
                        ...
                        <div class="box-car-list hv-one">
                            ...
                            <div class="content">
                                ...
                                <div class="days-box flex justify-space align-center">
                                    <div class="img-author">
                                        <img class="lazyload" data-src="assets/images/author/avt-cm3.jpg"
