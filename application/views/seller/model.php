                                                            ...
                                                            <tr>
                                                                 <td class="column-listing">
                                                                            <div class="tfcl-listing-product">
                                                                                <a href="listing-detail-v1.html">
                                                                                    <img src="<?= base_url(); ?>/assets/assets/images/dashboard/car-item3.png"
                                                                                        alt="image">
                                                                                </a>
                                                                ...
                                                                <td class="column-status">
                                                                    <?php if($detail->status==0){?>
                                                                            <span
                                                                                class="tfcl-listing-status status-publish"> Under Review
                                                                                 </span>
                                                                        </td>
                                                                        <?php } ?>
                                                                        <td class="column-date">
                                                                            <div class="tfcl-listing-date"><?= $posting_date; ?></div>
                                                                        </td>
