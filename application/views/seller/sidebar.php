    ...
    <aside class="sidebar-dashboard">
            ...
            <div class="author">
                <div class="avatar">
                    <img loading="lazy" id="tfre_avatar_thumbnail"
                        src="<?= base_url();?>/assets/assets/images/dashboard/avatar.png" alt="seller" title="seller">
                </div>
                <div class="content">
        ...
        <div class="db-content db-list-menu">
            ...
            <div class="db-dashboard-menu">
                <ul>
                    <li>
                        <a href="<?= base_url('seller'); ?>" class="<?= $this->uri->segment(1) == 'seller' ? 'active' : ''; ?> menu-index-1">
                    ...
                    <li>
                        <a href="<?= base_url('seller/my-listing'); ?>" class="<?= $this->uri->segment(2) == 'my-listing' ? 'active' : ''; ?> menu-index-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                   ...
                   <?php
                        ...
                        <ul class="submenu">
                            <li><a href="<?= base_url('seller/add-model'); ?>" class="<?= $this->uri->segment(2) == 'add-model' ? 'active' : ''; ?>">Add Models</a></li>
                            <li><a href="<?= base_url('seller/add-make'); ?>" class="<?= $this->uri->segment(2) == 'add-make' ? 'active' : ''; ?>">Add Make</a></li>
                            <li><a href="<?= base_url('seller/add-transmission'); ?>" class="<?= $this->uri->segment(2) == 'add-transmission' ? 'active' : ''; ?>">Add Transmission</a></li>
                            <li><a href="<?= base_url('seller/add-fuel-type'); ?>" class="<?= $this->uri->segment(2) == 'add-fuel-type' ? 'active' : ''; ?>">Add Fuel Type</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?= base_url('seller/my-profile'); ?>" class="<?= $this->uri->segment(2) == 'my-profile' ? 'active' : ''; ?> menu-index-9">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="<?= base_url('seller/change-password'); ?>" class="<?= $this->uri->segment(2) == 'change-password' ? 'active' : ''; ?> menu-index-10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
