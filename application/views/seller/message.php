                                        ...
                                        <div class="content-left">
                                            ...
                                            <ul class="list-user-chat">
                                                <li>
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt4.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                                ...
                                                <li class="active">
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt3.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                                            ...
                                                            <p>Proin at massa suscipit sem iaculis dignissim...</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt2.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                                ...
                                                <li>
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt1.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                                                <div class="name">Cody Fisher</div>
                                                                <span class="date">August 13, 2023</span>
                                                            </div>
                                                            <p>Proin a augue ut leo elementum tincidunt et...</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt7.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                                            ...
                                                            <p>Fusce tempor urna dictum ante porta pretium...</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt6.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                                                <div class="name">Bessie Cooper</div>
                                                                <span class="date">August 13, 2023</span>
                                                            </div>
                                                            <p>Mauris facilisis ipsum elementum nulla iaculis...</p>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="user-item">
                                                        <div class="avatar">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/chat-avt5.jpg"
                                                                alt="avatar">
                                                        </div>
                                                        <div class="content">
                                                            <div class="inner">
                                            ...
                                            <div class="content-inner-chat">
                                                <div class="current-user-chat">
                                                    <div class="chat-text">
                                                        ...
                                                        <div class="attrach">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/attrach1.png"
                                                                alt="file">
                                                            <img src="<?= base_url(); ?>/assets/assets/images/dashboard/attrach2.png"
                                                                alt="file">
                                                        </div>
                                                        <div class="date-pushlish mb-3">2:55 PM - Aug 17, 2024</div>
                                                    </div>
