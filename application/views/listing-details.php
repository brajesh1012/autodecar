                ...
                <div class="container-fluid">
                    <div class="swiper carousel-9 slider home mb-40">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="image-list-details">
                                    <a class="image" href="<?= base_url(); ?>/assets/assets/images/section/slider-listing1.jpg"  data-fancybox="gallery">
                                        <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-3.jpg"
                                            src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-3.jpg" alt="image">
                                    </a>
                                    <div class="specs-features-wrap flex-three">
                                        ...
                                        <a class="specs-features" href="<?= base_url(); ?>/assets/assets/images/section/slider-listing1.jpg"  data-fancybox="gallery">
                                            <div class="icon">
                                                <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                                            ...
                                            <div class="listing-features widget-listing box-sd mb-30 footer-col-block"
                                            ...
                                            <div class="listing-calculator loan-calculator-form widget-listing box-sd mb-30"
                                                        ...
                                                        <form method="post" id="loan-calculator"
                                                            ...
                                                            <fieldset class="name-wrap">
                                                                <label class="font-1 fs-14 fw-5">Total
                                                                    Price</label>
                                                                <input type="number" class="tb-my-input" name="name"
                                                            ...
                                                            <div class="grid-sw-2">
                                                                <fieldset class="email-wrap style-text">
                                                                    ...
                                                                    <input type="number" class="tb-my-input"
                                                                        name="number" placeholder="0%" required="">
                                                                </fieldset>
                                                                <fieldset class="phone-wrap style-text">
                                                                    ...
                                                                    <div class="nice-select relative" tabindex="0"><span
                                                                        ...
                                                                        <ul class="list style">
                                                                            ...
                                                                            <li data-value="3-months" class="option">3
                                                                                Monthly</li>
                                                                            <li data-value="6-months" class="option">6
                                                                                Monthly</li>
                                                                            <li data-value="12-months" class="option">12
                                                                                Monthly</li>
                                                                        </ul>
                                                                    </div>
                                                                </fieldset>
                                                            ...
                                                            <div class="grid-sw-2">
                                                                ...
                                                                <fieldset class="phone-wrap style-text">
                                                                    ...
                                                                    <div class="nice-select relative" tabindex="0"><span
                                                                            ...
                                                                            months</span>
                                                                        <ul class="list style">
                                                                            <li data-value="" class="option selected">1
                                                                                months
                                                                            </li>
                                                                            <li data-value="3-months" class="option">3
                                                                                months</li>
                                                            ...
                                                            <div class="list-total">
                                                                <ul>
                                                                    <li class="flex-three">
                                                                        ...
                                                                        <div class="fs-16 fw-5 lh-20 text-color-2 font">
                                                                            $0</div>
                                                                    </li>
                                                                    <li class="flex-three">
                                                                        <div
                                                                    ...
                                                                    <li class="flex-three">
                                                                        <div
                                                                            ...
                                                                            Monthly payment</div>
                                                                        <div class="fs-16 fw-5 lh-20 text-color-3 font">
                                                                            $60.00</div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                            ...
                                            <div class="listing-location widget-listing box-sd mb-30"
                                            ...
                                            <div class="listing-reviews flat-property-detail widget-listing box-sd mb-30"
                                                ...
                                                <div class="flat-tabs mb-60">
                                                    <div class="box-tab style5  center">
                                                        <ul class="menu-tab tab-title flex justify-space ">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="listing-sidebar">
                                ...
                                <div class="widget-listing box-sd">
