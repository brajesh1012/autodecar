                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="inner-heading flex-two flex-wrap gap-20">
                                <h1 class="heading-listing">Sale agents detail</h1>
                        ...
                        <div class="col-lg-12">
                            <div class="sale-agents-detail flex mb-60">
                                <div class="image">
                                    <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/img-box/team1.jpg"
                                        src="<?= base_url(); ?>/assets/assets/images/img-box/team1.jpg" alt="images">
                                </div>
                                <div class="content">
                                    <h2>About Honda cars pasig</h2>
                                    <div class="rating flex-three">
                                        <p class="font">2.975 Reviews</p>
                                        <div class="start">
                                    ...
                                    <p>Stay informed about emerging trends in the housing market, such as the demand for
                                        sustainable homes,
                                        technological advancements, and demographic shifts. Companies aligning with
                                        these trends may present
                                        attractive investment opportunities.
                                    </p>
                                    <div class="ul contact">
                                        <li class="flex-three">
                                            <i class="icon-autodeal-phone2"></i>
                                            <p class="fs-16 fw-5 lh-22 text-color-2 font">+7-445-556-8337</p>
                                        </li>
                                        <li class="flex-three">
                                            <i class="icon-autodeal-mail"></i>
                                            <p class="fs-16 fw-5 lh-22 text-color-2 font">darlenerobertson@gmail.com</p>
                                        </li>
                                    </div>
                                    <div class="icon-social style1">
                                        <a href="#"><i class="icon-autodeal-facebook"></i></a>
                                    ...
                                    <a href="#" class="sc-button"><span>Get quote</span></a>
                        ...
                        <div class="col-lg-12">
                            <div class="heading-section">
                                <h2>Explore all Used Car</h2>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="flat-tabs themesflat-tabs">
                                <div class="box-tab center">
                                    <ul class="menu-tab tab-title style flex flex-wrap">
                                        ...
                                        <div class="list-car-grid-4 gap-30">
                                            ...
                                            <div class="box-car-list hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="img-style">
                                                        <img class="lazyload"
                                                            data-src="<?= base_url(); ?>/assets/assets/images/car-list/car13.jpg"
                                            ...
                                            <div class="box-car-list hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="img-style">
                                                        <img class="lazyload"
                                                            data-src="<?= base_url(); ?>/assets/assets/images/car-list/car10.jpg"
                                            ...
                                            <div class="box-car-list hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="img-style">
                                                        <img class="lazyload"
                                                            data-src="<?= base_url(); ?>/assets/assets/images/car-list/car11.jpg"
                                            ...
                                            <div class="box-car-list hv-one">
                                                <div class="image-group relative ">
                                                    ...
                                                    <div class="img-style">
                                                        <img class="lazyload"
                                                            data-src="<?= base_url(); ?>/assets/assets/images/car-list/car12.jpg"
