                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="heading-widget flex-one mb-20 flex-wrap gap-8">
                                <div class="inner">
                                    <h1 class="title">2022 Skoda Slavia 1.0 TSI Ambition BSVI</h1>
                                    ...
                                    <div class="money text-color-3 font">$73,000</div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="image-list-details">
                                            <a class="image" href="<?= base_url(); ?>/assets/assets/images/section/listing-detai-1.jpg"  data-fancybox="gallery">
                                                <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-1.jpg"
                                                    src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-1.jpg" alt="image">
                                            </a>
                                            <div class="specs-features-wrap flex-three">
                                                ...
                                                <a class="specs-features" href="<?= base_url(); ?>/assets/assets/images/section/listing-detai-1.jpg"  data-fancybox="gallery">
                                                    <div class="icon">
                                                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                    ...
                                    <div class="swiper-slide">
                                        <div class="image-list-details">
                                            <a class="image" href="<?= base_url(); ?>/assets/assets/images/section/listing-detai-2.jpg"  data-fancybox="gallery">
                                                <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-2.jpg"
                                                    src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-2.jpg" alt="image">
                                            </a>
                                            <div class="specs-features-wrap flex-three">
                                                <a class="specs-features">
                                                    <div class="icon">
                                                ...
                                                <a class="specs-features" href="<?= base_url(); ?>/assets/assets/images/section/listing-detai-2.jpg"  data-fancybox="gallery">
                                                    <div class="icon">
                                                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                    ...
                                    <div class="swiper-slide">
                                        <div class="image-list-details">
                                            <a class="image" href="<?= base_url(); ?>/assets/assets/images/section/listing-detai-3.jpg"  data-fancybox="gallery">
                                                <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-3.jpg"
                                                    src="<?= base_url(); ?>/assets/assets/images/section/listing-detai-3.jpg" alt="image">
                                            </a>
                                            <div class="specs-features-wrap flex-three">
                                                <a class="specs-features">
                                                    <div class="icon">
                                                ...
                                                <a class="specs-features" href="<?= base_url(); ?>/assets/assets/images/section/listing-detai-3.jpg"  data-fancybox="gallery">
                                                    <div class="icon">
                                                        <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <path
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                                            ...
                                            <div class="listing-description mb-40">
                                                ...
                                                <div class="tfcl-listing-info mt-30">
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                        Morbi lacinia sit amet elit sed molestie. Sed neque
                                                        enim, iaculis id viverra in, scelerisque vitae nulla.
                                                    </p>
                                                    <p>Nulla egestas augue vitae mollis semper. Phasellus congue
                                                        neque et pulvinar gravida. Nam placerat, massa a
                                                        consequat scelerisque, lacus enim mattis felis,
                                                        pellentesque volutpat risus nisl et sapien. Proin ac
                                                        elit vitae velit iaculis varius non quis massa. Nunc
                                                        fringilla nulla sit amet mattis viverra. Vestibulum ante
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span
                                                                        class="listing-info-title">Cylinders:</span>
                                                        ...
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span class="listing-info-title">
                                                                        Stock Number:</span>
                                                                    <p class="listing-info-value">AB9084329457
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span class="listing-info-title">
                                                                        VIN Number:</span>
                                                                    <p class="listing-info-value">39847059856
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span
                                                                        class="listing-info-title">Doors:</span>
                                                        ...
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span class="listing-info-title">
                                                                        Year:</span>
                                                                    <p class="listing-info-value">2024</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span
                                                                        class="listing-info-title">Color:</span>
                                                                    <p class="listing-info-value">Blue,Gray</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span
                                                                        class="listing-info-title">Seats:</span>
                                                                    <p class="listing-info-value">7</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span
                                                                        class="listing-info-title">Transmission:</span>
                                                                    <p class="listing-info-value">Auto</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span class="listing-info-title">City
                                                                        MPG:</span>
                                                                    <p class="listing-info-value">20</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span class="listing-info-title">Engine
                                                                        Size:</span>
                                                                    <p class="listing-info-value">2.9</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-6 col-md-6 item">
                                                            ...
                                                            <div class="inner listing-infor-box">
                                                                ...
                                                                <div class="content-listing-info">
                                                                    <span class="listing-info-title">Drive
                                                                        Type:</span>
                                                                    <p class="listing-info-value">AWD –
                                                                        All-wheel drive</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-12 flat-accordion">
                                                        <div class="flat-toggle style-1">
                                                            <div class="toggle-title flex align-center">
                                                                <h5 class="fw-6">Comfort & Convenience</h5>
                                                                <div class="btn-toggle"></div>
                                                            </div>
                                                            <div class="toggle-content section-desc">
                                                                <p class="texts">Proin sed tellus porttitor,
                                                                    varius mauris vitae, tincidunt augue. Sed
                                                                    consectetur magna elit, sit amet faucibus
                                                                    tortor sodales vitae. Maecenas quis arcu
                                                                    est. Nam sit amet neque vestibulum,
                                                                    fringilla elit sit amet, volutpat nunc.</p>
                                                            </div>
                                                        </div>
                                                        <div class="flat-toggle style-1">
                                                            <div class="toggle-title flex align-center">
                                                                <h5 class="fw-6">Interior</h5>
                                                                <div class="btn-toggle"></div>
                                                            </div>
                                                            <div class="toggle-content section-desc">
                                                                <p class="texts">Proin sed tellus porttitor,
                                                        ...
                                                        <div class="flat-toggle style-1">
                                                            <div class="toggle-title flex align-center">
                                                                <h5 class="fw-6">Entertainment & Communication
                                                                </h5>
                                                                <div class="btn-toggle"></div>
                                                            </div>
                                                            <div class="toggle-content section-desc">
                                            ...
                                            <div class="listing-line "></div>
                                            <div class="listing-calculator loan-calculator-form pd-0" id="scrollspyHeading4">
                                                <div class="box-title">
                                                    <h2 class="title-ct">Auto Loan Calculator</h2>
                                                    <p>Use our calculator to estimate your monthly car payments.
                                                    </p>
                                                </div>

                                                <div id="comments" class="comments">
                                                    <div class="respond-comment">
                                                        <form method="post" id="loan-calculator"
                                                            class="comment-form form-submit" action="#"
                                                            accept-charset="utf-8" novalidate="novalidate">
                                                            <fieldset class="name-wrap">
                                                                <label class="font-1 fs-14 fw-5">Total
                                                                    Price</label>
                                                                <input type="number" class="tb-my-input"
                                                                    name="name" placeholder="$" required="">
                                                            </fieldset>
                                                            <div class="grid-sw-2">
                                                                <fieldset class="email-wrap style-text">
                                                                    <label class="font-1 fs-14 fw-5">Down
                                                                        payment</label>
                                                                    <input type="number" class="tb-my-input"
                                                                ...
                                                                <fieldset class="phone-wrap style-text">
                                                                    <label
                                                                        class="font-1 fs-14 fw-5">Terms</label>
                                                                    <div class="nice-select relative"
                                                                        tabindex="0"><span
                                                                            class="current">Monthly</span>
                                                                        <ul class="list style">
                                                                            <li data-value=""
                                                                                class="option selected">Monthly
                                                                            </li>
                                                                            <li data-value="3-months"
                                                                                class="option">3 Monthly</li>
                                                                            <li data-value="6-months"
                                                                                class="option">6 Monthly</li>
                                                                            <li data-value="12-months"
                                                                                class="option">12 Monthly</li>
                                                                        </ul>
                                                                    </div>
                                                                </fieldset>
                                                            </div>
                                                            <div class="grid-sw-2">
                                                                <fieldset class="email-wrap style-text">
                                                                    <label class="font-1 fs-14 fw-5">Interest
                                                                        rate</label>
                                                                    <input type="number" class="tb-my-input"
                                                                        name="number" placeholder="0%"
                                                                        required="">
                                                                ...
                                                                <fieldset class="phone-wrap style-text">
                                                                    <label
                                                                        class="font-1 fs-14 fw-5">Terms</label>
                                                                    <div class="nice-select relative"
                                                                        tabindex="0"><span class="current">1
                                                                            months</span>
                                                                        <ul class="list style">
                                                                            <li data-value=""
                                                                                class="option selected">1 months
                                                                            </li>
                                                                            <li data-value="3-months"
                                                                                class="option">3 months</li>
                                                                            <li data-value="6-months"
                                                                                class="option">6 months</li>
                                                                            <li data-value="12-months"
                                                                                class="option">12 months</li>
                                                                        </ul>
                                                                    </div>
                                                                </fieldset>
                                                            </div>
                                                            <div class="list-total">
                                                                <ul>
                                                                    <li class="flex-three">
                                                                        <div
                                                                            class="title-total fs-16 fw-5 lh-20 text-color-2 font">
                                                                            Down payment amount</div>
                                                                        <div
                                                                            class="fs-16 fw-5 lh-20 text-color-2 font">
                                                                            $0</div>
                                                                    </li>
                                                                    <li class="flex-three">
                                                                        <div
                                                                    ...
                                                                    <li class="flex-three">
                                                                        <div
                                                                            class="title-total fs-16 fw-5 lh-20 text-color-3 font">
                                                                            Monthly payment</div>
                                                                        <div
                                                                            class="fs-16 fw-5 lh-20 text-color-3 font">
                                                                            $60.00</div>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            ...
                                                            <div class="button-boxs">
                                                                <button class="sc-button" name="submit"
                                                                    type="submit">
                                            ...
                                            <div class="listing-location" id="scrollspyHeading3">
                                                <div class="box-title">
                                                    ...
                                                    <div class="list-icon-pf gap-8 flex-three">
                                                        ...
                                                        <p class="font-1">2972 Westheimer Rd. Santa Ana,
                                                            Illinois 85486 </p>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="box-tab style5  center">
                                                        <ul class="menu-tab tab-title flex ">
                                                            ...
                                                            <li class="item-title style">
                                                                <span
                                                                    class="inner fs-16 fw-5 lh-20">Mileage</span>
                                                            </li>
                                                            <li class="item-title style">
                                                                <span
                                                                    class="inner fs-16 fw-5 lh-20">Performance</span>
                                                            </li>
                                                            <li class="item-title style">
                                                                <span
                                                                    class="inner fs-16 fw-5 lh-20">Safety</span>
                                                            </li>
                                                            <li class="item-title style">
                                                                <span
                                                                    class="inner fs-16 fw-5 lh-20">Looks</span>
                                                            </li>
                                                            <li class="item-title style">
                                                                <span
                                                                    class="inner fs-16 fw-5 lh-20">Comfort</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                                ...
                                                                <div class="comment-list">
                                                                    <ol class="mb-30">
                                                                        <li>
                                                                            <div class="flex-one">
                                                                                <div
                                                                                    class="comment-list-wrap flex-three">
                                                                                    <div
                                                                                        class="images flex-none">
                                                            ...
                                                            <form method="post" id="contactform"
                                                                ...
                                                                <fieldset class="message-wrap">
                                                                    ...
                                                                    <textarea id="comment-message"
                                                                        name="message" rows="4" tabindex="4"
                            ...
                            <div class="listing-sidebar">
                                <div class="widget-listing mb-30">
                                    <div class="prolile-info flex-three mb-30">
                                        <div class="image">
                                            <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/author/avt1.jpg"
                                ...
                                <div class="widget-listing">
                                    ...
                                    <div class="listing-recommended mb-30">
                                        <div class="item flex">
                                            <div class="image">
                                                <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/car-list/car29.jpg"
                                        ...
                                        <div class="item flex">
                                            <div class="image">
                                                <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/car-list/car34.jpg"
                                                    src="<?= base_url(); ?>/assets/assets/images/car-list/car34.jpg" alt="image">
                                            </div>
                                            <div class="content">
