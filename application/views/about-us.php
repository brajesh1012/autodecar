                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="content relative z-2">
                                <div class="heading">
                                    <h1 class="text-color-1">Buying and selling cars <br> has never been easier!</h1>
                    ...
                    <div class="row">
                            ...
                            <div class="tf-team box hover-img">
                                <div class="images relative img-style">
                                    <a href="<?= base_url('sale-agent-details'); ?>">
                                        <img class="lazyloaded" data-src="<?= base_url(); ?>/assets/assets/images/img-box/team1.jpg"
                                            src="<?= base_url(); ?>/assets/assets/images/img-box/team1.jpg" alt="images">
                                    </a>
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="tf-team box hover-img">
                                <div class="images relative img-style">
                                    <a href="<?= base_url('sale-agent-details'); ?>">
                                        <img class="lazyloaded" data-src="<?= base_url(); ?>/assets/assets/images/img-box/team2.jpg"
                                            src="<?= base_url(); ?>/assets/assets/images/img-box/team2.jpg" alt="images">
                                    </a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="icon-autodeal-facebook"></i></a>
                                        <a href="#"><i class="icon-autodeal-twitter"></i></a>
                                ...
                                <div class="content flex-two">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="<?= base_url('sale-agent-details'); ?>">Ronald Richards</a>
                                        </h3>
                                        <p class=" text-color-2">Administrative Staff</p>
                                    </div>
                                    <div class="icon-box flex">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="tf-team box hover-img">
                                <div class="images relative img-style">
                                    <a href="<?= base_url('sale-agent-details'); ?>">
                                        <img class="lazyloaded" data-src="<?= base_url(); ?>/assets/assets/images/img-box/team3.jpg"
                                            src="<?= base_url(); ?>/assets/assets/images/img-box/team3.jpg" alt="images">
                                    </a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="icon-autodeal-facebook"></i></a>
                                        <a href="#"><i class="icon-autodeal-twitter"></i></a>
                                ...
                                <div class="content flex-two">
                                    <div class="inner">
                                        <h3 class="link-style-1"><a href="<?= base_url('sale-agent-details'); ?>">Leslie Alexander</a>
                                        </h3>
                                        <p class=" text-color-2">Administrative Staff</p>
                                    </div>
                                    <div class="icon-box flex">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="tf-team box hover-img">
                                <div class="images relative img-style">
                                    <a href="<?= base_url('sale-agent-details'); ?>">
                                        <img class="lazyloaded" data-src="<?= base_url(); ?>/assets/assets/images/img-box/team4.jpg"
                                            src="<?= base_url(); ?>/assets/assets/images/img-box/team4.jpg" alt="images">
                                    </a>
                                    <div class="icon-socials">
                                        <a href="#"><i class="icon-autodeal-facebook"></i></a>
                                        <a href="#"><i class="icon-autodeal-twitter"></i></a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="heading-section flex align-center justify-space flex-wrap gap-20">
                                ...
                                <a href="blog-grid.html" class="tf-btn-arrow">View all<i
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-car-list hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="img-style">
                                                    <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/car-list/car16.jpg"
                                                        src="<?= base_url(); ?>/assets/assets/images/car-list/car16.jpg" alt="image">
                                                </div>
                                            </div>
                                            <div class="content">
                                                ...
                                                <h5 class="link-style-1">
                                                    <a href="<?= base_url('list-details-v1'); ?>">2017 BMV X1 xDrive 20d xline</a>
                                                </h5>
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <div class="img-author">
                                                        <img class="lazyload"
                                                            data-src="<?= base_url(); ?>/assets/assets/images/author/avt-cm3.jpg"
                                                            src="<?= base_url(); ?>/assets/assets/images/author/avt-cm3.jpg" alt="image">
                                                        <span class="font text-color-2 fw-5">Kathryn Murphy</span>
                                                    </div>
                                                    <a href="<?= base_url('list-details-v1'); ?>" class="view-car">View car</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="box-car-list hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="img-style">
                                                    <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/car-list/car17.jpg"
                                                        src="<?= base_url(); ?>/assets/assets/images/car-list/car17.jpg" alt="image">
                                                </div>
                                            </div>
                                            <div class="content">
                                                <div class="text-address">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-car-list hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="img-style">
                                                    <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/car-list/car14.jpg"
                                                        src="<?= base_url(); ?>/assets/assets/images/car-list/car14.jpg" alt="image">
                                                </div>
                                            </div>
                                            <div class="content">
                                                <div class="text-address">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="box-car-list hv-one">
                                            <div class="image-group relative ">
                                                ...
                                                <div class="img-style">
                                                    <img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/car-list/car15.jpg"
                                                        src="<?= base_url(); ?>/assets/assets/images/car-list/car15.jpg" alt="image">
                                                </div>
                                            </div>
                                            <div class="content">
                                                <div class="text-address">
                                                ...
                                                <div class="days-box flex justify-space align-center">
                                                    <div class="img-author">
                                                        <img class="lazyload"
                                                            data-src="<?= base_url(); ?>/assets/assets/images/author/avt-cm2.jpg"
                                                            src="<?= base_url(); ?>/assets/assets/images/author/avt-cm2.jpg" alt="image">
