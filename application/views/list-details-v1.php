                ...
                <div class="listing-detail-wrap">
                    <div class="swiper mainslider slider home mb-40">
                        <div class="swiper-wrapper">
                            <?php $car_imgs = $this->db->where('car_list_id', $details->id)->get('car_img')->result();
                                ...
                                <div class="swiper-slide">
                                    <div class="image-list-details ">
                                        ...
                                        <!-- <div class="specs-features-wrap flex-three">
                                                ...
                                                <a class="specs-features"
                                                    href="<?= base_url('uploads/' . $car_img->photos); ?>"
                            ...
                            <!-- <div class="swiper-slide">
                                            <div class="image-list-details">
                                                <a class="image" href="<?= base_url(); ?>/assets/assets/images/section/slider-listing1.jpg" data-fancybox="gallery">
                                                    <img class="lazyload"
                                                        data-src="<?= base_url(); ?>/assets/assets/images/section/slider-listing1.jpg"
                                                        src="<?= base_url(); ?>/assets/assets/images/section/slider-listing1.jpg" alt="image">
                                                </a>
                                                <div class="specs-features-wrap flex-three">
                                                    <a class="specs-features">
                                                        <div class="icon">
                            ...
                            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= $details->mileage; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">
                                                            KM:</span>
                                                        <p class="listing-info-value"><?= $details->km; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">Ownership:</span>
                                                        <p class="listing-info-value">
                                                            <?= $details->ownership; ?> </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= $details->year; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        ...
                                                        <p class="listing-info-value"><?= $details->color; ?>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">Euro Norm:</span>
                                                        <p class="listing-info-value">
                                                            <?= $details->euro_norm; ?></p>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    <div class="content-listing-info">
                                                        <span class="listing-info-title">CO<sub>2</sub>
                                                            Emission:</span>
                                                        <p class="listing-info-value">
                                                            <?= $details->co2_emission; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-md-6 item">
                                                <div class="inner listing-infor-box">
                                                    ...
                                                    if (!empty($details->mfk_date)) {
                                                        ...
                                                        if ($dateObj) {
                                                            $mfk_value = $dateObj->format('m-Y'); // Output: 2025-07
                                                        }
                                                    }
                                                    ?>
                                                    <div class="content-listing-info">
                                                        <?php if ($selected_location == 2 ||  $selected_location == 3) { ?>
                                ...
                                <?php if ($details->vehicle_type != 1) { ?>
                                    <div class="listing-features footer-col-block " id="scrollspyHeading2">
                                        ...
                                        <?php $features = json_decode($details->other_features_and_extras, true); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 flat-accordion">
                                                <div class="flat-toggle style-1">
                                                    ...
                                                    $comforts = json_decode($details->comfort_and_interior, true);

                                                    $exteriors = json_decode($details->exterior_and_design, true);

                                                    $safety = json_decode($details->safety_and_assistance, true);

                                                    $multimedia = json_decode($details->multimedia_and_navigation, true);

                                                    $lighting = json_decode($details->lighting_and_visibility, true);

                                                    $engine = json_decode($details->engine_and_drive_technology, true);

                                                    ?>

                                                    <div class="toggle-title flex align-center">
                                                        <h5 class="fw-6">Comfort & Interior</h5>
                                                        <div class="btn-toggle"></div>
                                                    </div>
                                                    <div class="toggle-content section-desc">
                                                        <p class="texts"><?= implode(', ', $comforts) ?></p>
                                                    </div>
                                                </div>
                                                <div class="flat-toggle style-1">
                                                    <div class="toggle-title flex align-center">
                                                        <h5 class="fw-6">Lighting & Visibility</h5>
                                                        <div class="btn-toggle"></div>
                                                    </div>
                                                    <div class="toggle-content section-desc">
                                                        <p class="texts"><?= implode(', ', $lighting) ?></p>
                                                    </div>
                                                </div>
                                                <div class="flat-toggle style-1">
                                                    <div class="toggle-title flex align-center">
                                                        <h5 class="fw-6">Multimedia & Navigation
                                                        </h5>
                                                        <div class="btn-toggle"></div>
                                                    </div>
                                                    <div class="toggle-content section-desc">
                                                        <p class="texts"><?= implode(', ', $multimedia) ?></p>
                                                    </div>
                                                </div>

                                                <div class="flat-toggle style-1">
                                                    <div class="toggle-title flex align-center">
                                                        <h5 class="fw-6">Engine & Drive Technology
                                                        </h5>
                                                        <div class="btn-toggle"></div>
                                                    </div>
                                                    <div class="toggle-content section-desc">
                                                        <p class="texts"><?= implode(', ', $engine) ?></p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="flat-toggle style-1">
                                                    ...
                                                    <div class="toggle-content section-desc">
                                                        <p class="texts"><?= implode(', ', $exteriors) ?></p>
                                                    </div>
                                                </div>
                                                <div class="flat-toggle style-1">
                                                    <div class="toggle-title flex align-center">
                                                    ...
                                                    <div class="toggle-content section-desc">
                                                        <p class="texts"><?= implode(', ', $safety) ?></p>
                                                    </div>
                                                </div>
                ...
                <div class="listing-sidebar">
                    <div class="widget-listing mb-40">
                        <div class="heading-widget">
                            ...
                            ?>
                            <h2 class="title"><?= $details->year . " " . $make->name . " " . $model->name; ?>
                            </h2>
                            ...
                            <!-- <div class="money text-color-3 font">CHF <?= $details->total_price; ?></div> --><?php
                                                                                                                    ...
                                                                                                                    ?>
                            <div class="money text-color-3 font"><?php if (isset($_SESSION['location']) && ($_SESSION['location'] == 2 || $_SESSION['location'] == 3)) {
                                                                        echo $eur;
                                                                    } else {
                                                                        echo $chf;
                                                                    } ?></div>
                    ...
                    <div class="widget-listing">
                        <div class="listing-header mb-30">
                            <h3>More Vehicles from this Dealer<?php //echo $_SESSION['role_name']; 
                                                                ?></h3>
                        ...
                        <div class="listing-recommended mb-30">
                            ...
                            foreach ($new_vehicles as $new) {
                                ...
                                $chf = "CHF " . number_format($new->total_price, 0, '.', ".") . ",–";
                                $eur = "EUR " . number_format($new->total_price, 0, ',', '.') . ",--";
                            ...
                            ?>
                                <div class="item flex">
                                    ...
                                    <div class="content">
                                        ...
                                        <p class="fs-14 fw-7 text-color-2 font-1"><?php if (isset($_SESSION['location']) && ($_SESSION['location'] == 2 || $_SESSION['location'] == 3)) {
                                                                                        echo $eur;
                                                                                    } else {
                                                                                        echo $chf;
                                                                                    } ?></p>
                        ...
                        <a href="<?= base_url('listing-list?more=' . $new->added_by); ?>" class="fs-16 fw-5 font text-color-3 lh-22">View more <i
                                class="icon-autodeal-view-more"></i></a>
                    </div>
                    <?php } ?>
                            ...
                            <div class="image">
                                ...
                                <div class="content">
                                    ...
                                    <div class="verified flex-three">
                                        ...
                                        <span class="fs-12 fw-6 lh-16">Verified</span>
                                    </div>
                                </div>
