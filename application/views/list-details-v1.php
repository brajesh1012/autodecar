                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        <div class="swiper-slide">
                                            <div class="image-list-details " >
                                                <a class="image" href="<?= base_url('uploads/'.$car_img->photos); ?>"  data-fancybox="gallery">
                                                    <img class="lazyload"
                                                ...
                                                <div class="specs-features-wrap flex-three">
                                                    ...
                                                    <a class="specs-features" href="<?= base_url('uploads/'.$car_img->photos); ?>"  data-fancybox="gallery">
                                                        <div class="icon">
                                                            <svg width="18" height="14" viewBox="0 0 18 14" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                                <path
