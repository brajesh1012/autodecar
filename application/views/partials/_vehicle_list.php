                     ...
                     <div class="days-box">
                         ...
                         <div class="img-author">
                            <?php if(!empty($added->profile)){?>
                               <img class="lazyload" data-src="<?= base_url(); ?>uploads/profile/<?= $added->profile; ?>" src="<?= base_url(); ?>uploads/profile/<?= $added->profile; ?>" alt="image">
                                <?php }else{?><img class="lazyload" data-src="<?= base_url(); ?>/assets/assets/images/author/avt-cm1.jpg" src="<?= base_url(); ?>/assets/assets/images/author/avt-cm1.jpg" alt="image">
                                <?php } ?>
