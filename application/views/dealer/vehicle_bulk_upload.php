                ...
                <div class="content-area">
                    ...
                    <main id="main" class="main-content">
                        <div class="tfcl-dashboard">
                            ...
                            <form action="<?= base_url(ADMIN_PATH  . '/import-csv') ?>" enctype="multipart/form-data" onsubmit="return validateCSV()" method="POST">
                                    ...
                                    <div class="form-group-4">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <a href="<?= base_url(ADMIN_PATH  . '/download-csv'); ?>"    target="_blank" rel="noopener noreferrer" download><img src="<?= base_url('uploads/Download.png'); ?>" alt="Download" height="80px" width="80px"></a>
                                        </div>
