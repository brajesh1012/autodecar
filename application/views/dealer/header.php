                            ...
                            <div class="col-lg-12">
                                <div class="inner-container flex justify-space align-center">
                                        ...
                                        <nav class="main-menu show navbar-expand-md">
                                            <div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li><a href="<?= base_url('dealer/contact'); ?>">Contact</a></li>
                                                </ul>
                                            </div>
                                        </nav>
                                        <!-- Main Menu End-->
                                    ...
                                    <div class="header-account flex align-center">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer/my-listing'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer/my-favorite'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer/message'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer/my-review'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer/my-profile'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('dealer/change-password'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <div class="flat-bt-top">
                                            <a class="sc-button" href="<?= base_url('dealer/add-listing'); ?>">
