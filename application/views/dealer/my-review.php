                                        ...
                                        <div class="tfcl-card tfcl-dashboard-reviews">
                                            <ul>
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review9.png" alt="avatar">
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review8.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review7.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review6.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review5.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                                <b>Albert Flores</b> <span class="review-date">3 days
                                                                    ago</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="content">
                                                        <p>Donec bibendum nibh quis nisl luctus, at aliquet ipsum
                                                            bibendum. Fusce at dui tincidunt nulla semper venenatis at
                                                            et magna. Mauris turpis lorem, ultricies vel justo sed.</p>
                                                    </div>
                                                    <div class="rating-wrap">
                                                        <div class="form-group">
                                                            <div class="star-rating-review">
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review4.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                                <b>Ralph Edwards</b> <span class="review-date">3 days
                                                                    ago</span>
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review3.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                                <b>Marvin McKinney</b> <span class="review-date">3 days
                                                                    ago</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review2.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                                <b>Jacob Jones</b> <span class="review-date">3 days
                                                                    ago</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review1.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                                <b>Cody Fisher</b> <span class="review-date">3 days
                                                                    ago</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <li class="comment-by-user">
                                                    <div class="group-author">
                                                        <img loading="lazy" class="avatar" width="56" height="56"
                                                            src="<?= base_url(); ?>/assets/assets/images/dashboard/review10.png" alt="avatar">
                                                        <div class="group-name">
                                                            <div class="review-name">
                                                                <b>Devon Lane</b> <span class="review-date">3 days
                                                                    ago</span>
                                                            </div>
                                                        </div>
                                                    </div>
