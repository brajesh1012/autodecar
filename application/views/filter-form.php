...
<div class="box">
    <div class="form-section d-flex">
        ...
        <div class="d-flex side align-items-center justify-content-center sidebar">
            <div class="sidebar-icon active" tabindex="0" aria-label="Car">
                <!-- Car SVG -->
            ...
            <div class="sidebar-icon" tabindex="0" aria-label="Motorhome" title="Motorhome">
                <!-- Motorhome SVG -->
            ...
            <div class="sidebar-icon" tabindex="0" aria-label="Truck" title="Truck">
                <!-- Truck SVG -->
        ...
        <!-- Main Filter Row -->
        <form id="mainFilterForm" action="<?= site_url('search') ?>" method="get" autocomplete="off">
        <div class="row g-3">
...
<div id="advFilters" class="adv-filters" aria-hidden="true" style="display:none;">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <span class="fw-bold">Advanced Filters</span>
    <button type="button" class="btn-close" aria-label="Close" id="closeAdvFilters"></button>
  </div>
...
const advBtn = document.getElementById('toggleAdvFilters');
const advFilters = document.getElementById('advFilters');
const closeAdvFilters = document.getElementById('closeAdvFilters');
if (advBtn && advFilters) {
    advBtn.addEventListener('click', function() {
        advFilters.style.display = advFilters.style.display === 'block' ? 'none' : 'block';
        advFilters.setAttribute('aria-hidden', advFilters.style.display !== 'block');
    });
}
if (closeAdvFilters && advFilters) {
    closeAdvFilters.addEventListener('click', function() {
        advFilters.style.display = 'none';
        advFilters.setAttribute('aria-hidden', 'true');
    });
}
// Reset form
...
// Placeholder for dynamic model population
