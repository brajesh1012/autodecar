                    ...
                    <div class="inner-container flex justify-space align-center">
                        ...
                        <div class="header-account flex align-center">
                            ...
                            <div class="dropdown-menu dashboard-menu">
                                ...
                                <a class="dropdown-item" href="<?= base_url('admin/my-listing'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path
                                ...
                                <a class="dropdown-item" href="<?= base_url('admin/my-favorite'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <a class="dropdown-item" href="<?= base_url('admin/message'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <a class="dropdown-item" href="<?= base_url('admin/my-review'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path
                                ...
                                <a class="dropdown-item" href="<?= base_url(ADMIN_PATH . '/dealer-profile'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <?php }else{ ?>
                                        ...
                                        <a class="dropdown-item" href="<?= base_url(ADMIN_PATH . '/my-profile'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        <?php } ?>
                                <a class="dropdown-item" href="<?= base_url(ADMIN_PATH . '/change-password'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <a class="dropdown-item" href="<?= base_url('logout'); ?>"><svg
                                        xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                        fill="none">
                                        <g opacity="0.2">
                                            <path
    ...
    <div class="mobile-menu">
        ...
        <nav class="menu-box">
            <div class="nav-logo"><a href="index.html"><img
                        src="<?= base_url();?>/assets/assets/images/logo/logo@2x.png" alt width="197" height="48"></a>
            </div>
