                            ...
                            <div class="col-lg-12">
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="header-account flex align-center">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin/my-listing'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin/my-favorite'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin/message'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin/my-review'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin/my-profile'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <a class="dropdown-item" href="<?= base_url('admin/change-password'); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                            <g opacity="0.2">
                                        ...
                                        <div class="flat-bt-top">
                                            <a class="sc-button" href="<?= base_url(ADMIN_PATH . '/add-listing'); ?>">
