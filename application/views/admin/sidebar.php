    ...
    <aside class="sidebar-dashboard">
        ...
        <div class="db-content db-list-menu">
            ...
            <div class="db-dashboard-menu">
                <ul>
                    <li>
                        <a href="<?= base_url('dashboard'); ?>" class="<?= $this->uri->segment(1) == 'dashboard' ? 'active' : ''; ?> menu-index-1">
                    ...
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/users'); ?>" class="<?= $this->uri->segment(1) == 'users' ? 'active' : ''; ?> menu-index-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                     ...
                     <li>
                        <a href="<?= base_url(ADMIN_PATH . '/subscribed-users'); ?>" class="<?= $this->uri->segment(1) == 'subscribed-users' ? 'active' : ''; ?> menu-index-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                            ...
                            </svg>Subscribed Users</a>
                    </li>

                     <?php } ?>

                    <!-- <li>
                        <a href="<?= base_url(ADMIN_PATH . '/my-listing'); ?>" class="<?= $this->uri->segment(1) == 'my-listing' ? 'active' : ''; ?> menu-index-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
...
<!-- 
                    <?php if($_SESSION['role_name'] !="Seller"){ ?>
                        <li>
                        <a href="<?= base_url(ADMIN_PATH  . '/bulk-upload-view'); ?>" class="<?= $this->uri->segment(1) == 'bulk-upload-view' ? 'active' : ''; ?> menu-index-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                ...
                <?php } ?> -->
                   ...
                   <?php
                        ...
                        <ul class="submenu">
                            <!-- Vehicle List-->
                              ...
                              <li>
                                    <a href="<?= base_url(ADMIN_PATH . '/my-listing'); ?>" class="<?= $this->uri->segment(1) == 'my-listing' ? 'active' : ''; ?> ">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                            fill="none">
                                            <g opacity="0.2">
                                                <path
                            ...
                            <!-- Vehicle Bulk upload -->
                                ...
                                <?php if($_SESSION['role_name'] !="Seller"){ ?>
                                    <li>
                                    <a href="<?= base_url(ADMIN_PATH  . '/bulk-upload-view'); ?>" class="<?= $this->uri->segment(1) == 'bulk-upload-view' ? 'active' : ''; ?>">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                            fill="none">
                                            <g opacity="0.2">
                                                <path
                            ...
                            <li><a href="<?= base_url(ADMIN_PATH . '/add-make'); ?>" class="<?= $this->uri->segment(1) == 'add-make' ? 'active' : ''; ?>">
                                 <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                            ...
                            <li><a href="<?= base_url(ADMIN_PATH . '/add-model'); ?>" class="<?= $this->uri->segment(1) == 'add-model' ? 'active' : ''; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                                        d="M10.0135 2.55687H6.58608C3.76733 2.55687 2 4.55245 2 7.37762V14.9988C2 17.824 3.75908 19.8195 6.58608 19.8195H14.6747C17.5027 19.8195 19.2617 17.824 19.2617 14.9988V11.3065"
                            ...
                            </svg>Add Variant</a></li>
                            <li><a href="<?= base_url(ADMIN_PATH . '/add-transmission'); ?>" class="<?= $this->uri->segment(1) == 'add-transmission' ? 'active' : ''; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                                        d="M10.0135 2.55687H6.58608C3.76733 2.55687 2 4.55245 2 7.37762V14.9988C2 17.824 3.75908 19.8195 6.58608 19.8195H14.6747C17.5027 19.8195 19.2617 17.824 19.2617 14.9988V11.3065"
                            ...
                            </svg>Add Transmission</a></li>
                            <li><a href="<?= base_url(ADMIN_PATH . '/add-fuel-type'); ?>" class="<?= $this->uri->segment(1) == 'add-fuel-type' ? 'active' : ''; ?>"> <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                                        d="M10.0135 2.55687H6.58608C3.76733 2.55687 2 4.55245 2 7.37762V14.9988C2 17.824 3.75908 19.8195 6.58608 19.8195H14.6747C17.5027 19.8195 19.2617 17.824 19.2617 14.9988V11.3065"
                 ...
                 <?php if(@$_SESSION['role_name']=="Admin"){ ?>
                    <li class="d-none">
                        <a href="<?= base_url(ADMIN_PATH . '/permission'); ?>" class="<?= $this->uri->segment(1) == 'permission' ? 'active' : ''; ?> menu-index-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                    ...
                    <li class="d-none">
                        <a href="<?= base_url(ADMIN_PATH . '/roles'); ?>" class="<?= $this->uri->segment(1) == 'roles' ? 'active' : ''; ?> menu-index-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                    ...
                    <!-- <li>
                        <a href="<?= base_url(ADMIN_PATH . '/my-favorite'); ?>" class="<?= $this->uri->segment(1) == 'my-favorite' ? 'active' : ''; ?> menu-index-6">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/message'); ?>" class="<?= $this->uri->segment(1) == 'message' ? 'active' : ''; ?> menu-index-7">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/my-review'); ?>" class="<?= $this->uri->segment(1) == 'my-review' ? 'active' : ''; ?> menu-index-8">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                    ...
                    <?php if(@$_SESSION['role_name']=="Dealer"){ ?>
                     <li>
                        <a href="<?= base_url(ADMIN_PATH . '/dealer-profile'); ?>" class="<?= $this->uri->segment(1) == 'dealer-profile' ? 'active' : ''; ?> menu-index-9">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/my-profile'); ?>" class="<?= $this->uri->segment(1) == 'my-profile' ? 'active' : ''; ?> menu-index-9">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/chat-overview'); ?>" class="<?= $this->uri->segment(1) == 'chat-overview' ? 'active' : ''; ?> menu-index-5">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                    ...
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/add-plan'); ?>" class="<?= $this->uri->segment(1) == 'add-plan' ? 'active' : ''; ?> menu-index-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
                            ...
                            </svg>Subscription Plan</a>
                    </li>
                    <li>
                        <a href="<?= base_url(ADMIN_PATH . '/change-password'); ?>" class="<?= $this->uri->segment(1) == 'change-password' ? 'active' : ''; ?> menu-index-10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <li>
                        <a href="<?= base_url('logout'); ?>" class="<?= $this->uri->segment(1) == 'logout' ? 'active' : ''; ?> menu-index-11">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22"
                                fill="none">
                                <g opacity="0.2">
                                    <path
