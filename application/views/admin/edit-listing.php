                ...
                <div class="content-area">
                    ...
                    <main id="main" class="main-content">
                        <div class="tfcl-dashboard">
                            ...
                            <form action="<?= base_url(ADMIN_PATH . '/edit-listing/' . $cars->id) ?>" method="POST"
                                ...
                                <div class="tfcl-add-listing car-details">
                                    ...
                                    <div class="form-group-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="vehicle_type" onchange="on_change_vehicle();" id="vehicle_type_id">
                                                ...
                                                ?>
                                                    <option value="<?= $vehicle_type->id; ?>" data-type="<?= $type_key ?>"
                                                        <?php if ($cars->vehicle_type == $vehicle_type->id) {
                                                            echo "selected";
                                                        } ?>>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="cat_id" onchange="on_change_cat();" id="cat_id">
                                                <option value="">Select Category</option>
                                                <?php foreach ($categories as $cat) {
                                                    $cat_key = strtolower(str_replace(' ', '_', $cat->name));
                                                ?>
                                                    <option value="<?= $cat->id; ?>" data-type="<?= $cat_key ?>"
                                                        <?php if ($cars->cat_id == $cat->id) {
                                                            echo "selected";
                                                        } ?>>
                                                        <?= $cat->name; ?></option>
                                                <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="make" onchange="on_change_make();" id="make_id">
                                                <option value="">Select Make</option>
                                                <?php foreach ($makes as $make) { ?>
                                                    <option value="<?= $make->id; ?>"
                                                        <?php if ($cars->make == $make->id) {
                                                            echo "selected";
                                                        } ?>>
                                                        <?= $make->name; ?></option>
                                                <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="model" onchange="on_change_model();" id="model_id">
                                                <option value="">Select Model</option>
                                                <?php foreach ($models as $model) { ?>
                                                    <option value="<?= $model->id; ?>"
                                                        <?php if ($cars->model == $model->id) {
                                                            echo "selected";
                                                        } ?>>
                                                        <?= $model->name; ?></option>
                                                <?php } ?>
                                            ...
                                            <select class="form-control" name="variant" id="variant_id">
                                                ...
                                                <?php foreach ($variants as $variant) { ?>
                                                    <option value="<?= $variant->id; ?>"
                                                        <?php if ($cars->variant == $variant->id) {
                                                            echo "selected";
                                                        } ?>>
                                                        <?= $variant->name; ?></option>
                                                <?php } ?>
                                            ...
                                            <select class="form-control" name="fuel_type" id="fuel_type">
                                                ...
                                                <?php foreach ($fuel_types as $fuel_type) { ?>
                                                    <option value="<?= $fuel_type->name; ?>"
                                                        <?php if ($cars->fuel_type == $fuel_type->name) {
                                                            echo "selected";
                                                        } ?>>
                                                        <?= $fuel_type->name; ?>
                                                    </option>
                                            ...
                                            <select class="form-control" name="transmission">
                                                ...
                                                <?php foreach ($transmissions as $transmission) { ?>
                                                    <option value="<?= $transmission->name; ?>"
                                                        <?php if ($cars->transmission == $transmission->name) {
                                                            echo "selected";
                                                        } ?>>
                                                        <?= $transmission->name; ?>
                                                    </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="vehicle_condition">
                                                ...
                                                <option value="Good"
                                                    <?php if ($cars->vehicle_condition == "Good") {
                                                        echo "selected";
                                                    } ?>>
                                                    Good</option>
                                                <option value="Export"
                                                    <?php if ($cars->vehicle_condition == "Export") {
                                                        echo "selected";
                                                    } ?>>
                                                    Export</option>
                                                <option value="Accident Vehicle"
                                                    <?php if ($cars->vehicle_condition == "Accident Vehicle") {
                                                        echo "selected";
                                                    } ?>>
                                    ...
                                    <div class="form-group-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="ownership" class="form-control" id="ownership">
                                                ...
                                                <option value="1st"
                                                    <?php if ($cars->ownership == '1st') {
                                                        echo "selected";
                                                    } ?>>1st
                                                </option>
                                                <option value="2nd"
                                                    <?php if ($cars->ownership == '2nd') {
                                                        echo "selected";
                                                    } ?>>2nd
                                                </option>
                                                <option value="3rd"
                                                    <?php if ($cars->ownership == '3rd') {
                                                        echo "selected";
                                                    } ?>>3rd
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="euro_norm" class="form-control" id="euro_norm">
                                                ...
                                                <option value="6 Euro"
                                                    <?php if ($cars->euro_norm == '6 Euro') {
                                                        echo "selected";
                                                    } ?>>6 Euro
                                                </option>
                                                <option value="5 Euro"
                                                    <?php if ($cars->euro_norm == '5 Euro') {
                                                        echo "selected";
                                                    } ?>>5 Euro
                                                </option>
                                                <option value="4 Euro"
                                                    <?php if ($cars->euro_norm == '4 Euro') {
                                                        echo "selected";
                                                    } ?>>4 Euro
                                                </option>
                                                <option value="3 Euro"
                                                    <?php if ($cars->euro_norm == '3 Euro') {
                                                        echo "selected";
                                                    } ?>>3 Euro
                                                </option>
                                            </select>
                                    ...
                                    <div class="form-group-4">
                                        <div class="form-group ">
                                            ...
                                            <select class="form-control" name="winter_tires" id="winter_tires">
                                                ...
                                                <option value="Yes"
                                                    <?php if ($cars->winter_tires == 'Yes') {
                                                        echo "selected";
                                                    } ?>>Yes
                                                </option>
                                                <option value="No"
                                                    <?php if ($cars->winter_tires == 'No') {
                                                        echo "selected";
                                                    } ?>>No
                                                </option>
                                            </select>
                                        ...
                                        <div class="form-group  feature-car feature-bus" style="display:none;">
                                            ...
                                            <select name="ac_type" class="form-control" id="">
                                                ...
                                                <option value="No AC"
                                                    <?php if ($cars->ac_type == 'No AC') {
                                                        echo "selected";
                                                    } ?>>No AC
                                                </option>
                                                <option value="Manual AC"
                                                    <?php if ($cars->ac_type == 'Manual AC') {
                                                        echo "selected";
                                                    } ?>>
                                                    Manual AC</option>
                                                <option value="Automatic AC"
                                                    <?php if ($cars->ac_type == 'Automatic AC') {
                                                        echo "selected";
                                                    } ?>>
                                                    Automatic AC</option>
                                                <option value="Dual-Zone Automatic AC"
                                                    <?php if ($cars->ac_type == 'Dual-Zone Automatic AC') {
                                                        echo "selected";
                                                    } ?>>
                                                    Dual-Zone Automatic AC</option>
                                                <option value="Tri-Zone Automatic AC"
                                                    <?php if ($cars->ac_type == 'Tri-Zone Automatic AC') {
                                                        echo "selected";
                                                    } ?>>
                                                    Tri-Zone Automatic AC</option>
                                                <option value="4-Zone Automatic AC"
                                                    <?php if ($cars->ac_type == '4-Zone Automatic AC') {
                                                        echo "selected";
                                                    } ?>>
                                        ...
                                        <!-- <div class="form-group feature-car feature-bus" style="display:none;">
                                            <label for="listing_title"> 4x4*</label>
                                                    <select name="4x4" class="form-control" id="four_by_four">
                                                        <option value="">Select</option>
                                                        <option value="yes"  <?php if ($cars->four_by_four == 'yes') {
                                                                                    echo "selected";
                                                                                } ?> >Yes</option>
                                                        <option value="no"  <?php if ($cars->four_by_four == 'no') {
                                                                                echo "selected";
                                                                            } ?> >No</option>
                                                    </select>
                                        </div> 
                                           ...
                                           <div class="form-group feature-car feature-bus" style="display:none;">
                                            <label for="listing_title"> Navigation System *</label>
                                                    <select name="navigation_system" class="form-control" id="">
                                                        <option value="">Select</option>
                                                        <option value="yes"   <?php if ($cars->navigation_system == 'yes') {
                                                                                    echo "selected";
                                                                                } ?>  >Yes</option>
                                                        <option value="no"  <?php if ($cars->navigation_system == 'no') {
                                                                                echo "selected";
                                                                            } ?>>No</option>
                                                    </select>
                                        </div> -->
                                        ...
                                        <div class="form-group feature-car feature-bus" style="display:none;">
                                            ...
                                            <select class="form-control" name="parking_sensors" class="form-control">
                                                <option value="">Select</option>
                                                <option value="None"
                                                    <?php if ($cars->parking_sensors == 'None') {
                                                        echo "selected";
                                                    } ?>>
                                                    None</option>
                                                <option value="Rear Only"
                                                    <?php if ($cars->parking_sensors == 'Rear Only') {
                                                        echo "selected";
                                                    } ?>>
                                                    Rear Only</option>
                                                <option value="Front Only"
                                                    <?php if ($cars->parking_sensors == 'Front Only') {
                                                        echo "selected";
                                                    } ?>>
                                                    Front Only</option>
                                                <option value="Front and Rear"
                                                    <?php if ($cars->parking_sensors == 'Front and Rear') {
                                                        echo "selected";
                                                    } ?>>
                                            ...
                                            ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="comfort_and_interior[]"
                                                        value="<?= $comfort->name ?>" <?php if (!empty($selected_comforts) && in_array($comfort->name, $selected_comforts)) {
                                                                                            echo 'checked';
                                                                                        } ?>><?= $comfort->name ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            foreach ($safety_and_assistance as $safety) { ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="safety_and_assistance[]"
                                                        value="<?= $safety->name ?>"
                                                        <?php if (!empty($selected_safety_and_assistance) && in_array($safety->name, $selected_safety_and_assistance)) {
                                                            echo 'checked';
                                                        } ?>><?= $safety->name ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            foreach ($lighting_and_visibility as $lighting) { ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="lighting_and_visibility[]"
                                                        value="<?= $lighting->name ?>"
                                                        <?php if (!empty($selected_lighting_and_visibility) && in_array($lighting->name, $selected_lighting_and_visibility)) {
                                                            echo 'checked';
                                                        } ?>><?= $lighting->name ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            foreach ($multimedia_and_navigation as $multimedia) { ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="multimedia_and_navigation[]"
                                                        ...
                                                        <?php if (!empty($selected_multimedia_and_navigation) && in_array($multimedia->name, $selected_multimedia_and_navigation)) {
                                                            echo 'checked';
                                                        } ?>><?= $multimedia->name ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            foreach ($engine_and_drive_technology as $engine) { ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="engine_and_drive_technology[]"
                                                        value="<?= $engine->name ?>"
                                                        <?php if (!empty($selected_engine_and_drive_technology) && in_array($engine->name, $selected_engine_and_drive_technology)) {
                                                            echo 'checked';
                                                        } ?>><?= $engine->name ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            foreach ($exterior_and_design as $exterior) { ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="exterior[]" value="<?= $exterior->name ?>"
                                                        <?php if (!empty($selected_exterior_and_design) && in_array($exterior->name, $selected_exterior_and_design)) {
                                                            echo 'checked';
                                                        } ?>><?= $exterior->name ?>
                                                </div>
                                            <?php } ?>
                                            ...
                                            foreach ($other_features_and_extras as $other) { ?>
                                                <div class="form-group">
                                                    <input type="checkbox" name="other_features_and_extras[]"
                                                        value="<?= $other->name ?>"
                                                        <?php if (!empty($selected_other_features_and_extras) && in_array($other->name, $selected_other_features_and_extras)) {
                                                            echo 'checked';
                                                        } ?>><?= $other->name ?>
                                                </div>
                                            <?php } ?>
                                    ...
                                    <div class="form-group-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="is_negotiable" class="form-control" id="is_negotiable">
                                                <option value="">Select</option>
                                                <option value="yes"
                                                    <?php if ($cars->is_negotiable == 'yes') {
                                                        echo "selected";
                                                    } ?>>Yes
                                                </option>
                                                <option value="no"
                                                    <?php if ($cars->is_negotiable == 'no') {
                                                        echo "selected";
                                                    } ?>>No
                                                </option>
                                            </select>
                        ...
                        <div class="tfcl-table-listing">
                            <div class="table-responsive">
                                <table id="example" class="cell-border">
                                    ...
                                    <tbody>
                                        <?php $car_img = $this->db->where('car_list_id', $cars->id)->get('car_img')->result();
