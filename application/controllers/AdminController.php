...
// print_r($plan);die;
    ...
    \Stripe\Stripe::setApiKey("YOUR_STRIPE_SECRET_KEY"); // Replace with environment variable or config
    ...
    $session = \Stripe\Checkout\Session::create([
        ...
        'mode' => 'payment',
        'success_url' => base_url(ADMIN_PATH . '/payment-success/' . $plan_id),
        'cancel_url'  => base_url(ADMIN_PATH . '/dashboard'),
    ]);

    // Redirect to Stripe Checkout
    redirect($session->url, 'refresh');
    // ---- Stripe Code End ----
}


public function payment_success($plan_id) {
    // echo "Payment successful for plan ID: " . $plan_id;
    $user_id = $_SESSION['user_id'];
    ...
    $invoice_data = [
        ...
        'start_date' => $start_date,
        'end_date' => $end_date,
        'listing_allowed' => $plan->listing_limit,
