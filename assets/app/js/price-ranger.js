...
// Initialize slider:
var rangeSliders = document.getElementById('slider-range');
$(document).ready(function () {
  // $('.noUi-handle').on('click', function () {
  //   $(this).width(50);
  // });
  ...
  // Call AJAX when slider value is changed
  rangeSliders.noUiSlider.on('change', function () {
...
$(document).ready(function () {
  ...
  rangeSlider2.noUiSlider.on('update', function (values, handle) {
    // Show values in span
    $('#slider-range-value01').text(values[0]);
    $('#slider-range-value02').text(values[1]);
...
$(document).ready(function () {
  ...
  rangeSlider.noUiSlider.on('update', function (values, handle) {
    // Show values in span
    $('#slider-range-value03').text(values[0]);
    $('#slider-range-value04').text(values[1]);

    // Set values in hidden inputs
    $('input[name="min-value3"]').val(moneyFormat.from(values[0]));
    $('input[name="max-value3"]').val(moneyFormat.from(values[1]));
  });
